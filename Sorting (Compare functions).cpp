...
/// that example demonstrates GREEDY technique
/**
Knapsack problem
...
struct item /// struct in C++ is just a class with public elements
{
	int weight, val;
};
...
int main()
{
    ...
    sort(a, a+n); /// because sorting an array of pairs is according to the first value
    reverse(a, a+n);
